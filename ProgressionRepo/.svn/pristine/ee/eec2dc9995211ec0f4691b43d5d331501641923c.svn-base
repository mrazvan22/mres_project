...
%% ========== Iterative unsupervised lcustering
% Iteratively cluster the data to patients and likelihoods using EM with
% MoG and reassign memberships to control and patient classes untill the
% cluster memberships stop changing
