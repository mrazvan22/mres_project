...
for c_size=1:length(div_size)
    ...
    threshold_flag=0;
    nAttempts=5;  % this only needs to be defined if version_likelihood=13;
    [likelihood, gmix_struct] = ...
        EBDPComputeLikelihood(this_data_patients, this_data_controls, version_likelihood,threshold_flag, nAttempts);
