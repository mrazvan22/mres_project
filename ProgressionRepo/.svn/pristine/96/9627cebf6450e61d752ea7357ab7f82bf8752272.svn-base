...
function [parm_struct] = EBDPMCMCTestWithParams1k(data_controls, data_patients, parm_mcmc)
...
change_step_muNE=0.0002;
change_step_muE=0.0002;
change_step_sigNE=0.0002;
change_step_sigE=0.0002;
