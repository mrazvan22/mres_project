...
function [parm_struct] = EBDPMCMCTestWithParams0k(data_controls, data_patients, parm_mcmc,version_likelihood,threshold_flag,nAttempts)
...
for roi=1:nr_events
    ...
    if threshold_flag
        ...
        for cIndx=1:length(indx)
            ...
            if data_tot(indx(cIndx),roi)<thisMean_noevent(roi)
