...
function [pr_models, postModel]=faceRecognitionVersion2TDistPatchesDemoFastTest(k,patchLibrary,testPatch,imageIDTest,n_Patch,nX,nY,nZ,patchNum)
...
%     if (cPatch==12)|(cPatch==21)|(cPatch==27)|(cPatch==28)|(cPatch==29)  
%     else
    if(~mod(cPatch,8))
    else
         pCount=pCount+1;
