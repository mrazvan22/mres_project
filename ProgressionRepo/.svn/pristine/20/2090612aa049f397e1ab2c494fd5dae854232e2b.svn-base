function logProbXGivenCaseMuSigma=findLikelihoodCurrentOrderingAndParams(likelihood,event_order_current,prior_thisMean_control,prior_thisMean_patient,prior_thisCov_control,prior_thisCov_patient)
...
for j=I_select
    ...
    for k=1: nr_events
        ...
        probXjGivenSKMuSigma(k)=sum(log(probXjGivenSK_event))+sum(log(probXjGivenSK_no_event));
