...
function [logLik, logLikmat, model_bestfit] = ...
    logLikelihoodAtrophyModel_thrp(prob_pat, prob_tot, thr_p, order_events, version)
...
p_A_D = (prob_pat + repmat(thr_p, 1, nr_pat))./(prob_tot + 2*repmat(thr_p, 1, nr_pat));
