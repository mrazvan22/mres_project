function DataSimulationWithParamsDemo0k
clear
%close all
...
change_step_muNE=0.005;       % the step size for changing Mean No Event
change_step_muE=0.005;        % the step size for changing Mean Event
change_step_sigNE=0.005;      % the step size for changing Sigma No Event  
change_step_sigE=0.005;       % the step size for changing Sigma Event                       
                              
                              
parm_struct = EBDPMCMCTestWithParams0k(data_controls, ... 
    data_patients, parm_mcmc,version_likelihood,threshold_flag, ...
    nAttempts,change_step_muNE,change_step_muE,change_step_sigNE,change_step_sigE);
